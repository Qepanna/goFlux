...
To help you create an auxiliary file (used for the [manual identification of measurements](manualID.qmd#sec-manID)), you can [Download](quarto/docs/example_auxfile.xlsx) this example Excel spreadsheet.
