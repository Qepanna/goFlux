...
### `flux2pdf` for save plots to pdf
...
| `outfile` | a character string indicating the full name of the pdf output file (including the path and '.pdf' extension). If outfile is not provided, it will be saved in R's temporary direc... |
