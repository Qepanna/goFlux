#' Import function for the Automated ECOFlux chambers (GAIA2TECH) synced with
#' multiple instruments
#'
#' Imports single raw files generated by DMR for the Automated
#' ECOFlux chambers linked with up to three greenhouse gas analyzers.
...
#'
#' @instrumentlink DMR|GAIA|Automated ECOFlux chamber (GAIA2TECH)|https://www.dmr.eu/technologies/gas-emission-eco2flux/automated-eco2flux-chamber/
...
#'
#' @returns A data frame containing raw data from multiple Automated ECOFlux
#' chambers (GAIA2TECH) and gas analyzers.
#'
#' @details
#' This function has been designed for up to 9 Automated ECOFlux chambers
#' synced with two GHG analyzers from LI-COR (LI-7810:
#' \ifelse{html}{\out{CO<sub>2</sub>}}{\eqn{CO[2]}{ASCII}},
#' \ifelse{html}{\out{CH<sub>4</sub>}}{\eqn{CH[4]}{ASCII}} and
...
#' file, not the date format in the file name. For the Automated ECOFlux chamber,
