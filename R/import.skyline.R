...
#' EarthBound Scientific from the datalog file created by DMR. Default
...
#'
#' @instrumentlink DMR|skyline|SkyLine2D system (EarthBound Scientific)
...
#'        a dry fraction.
#'
#' @returns A data frame containing raw data from the SkyLine2D system from
#' EarthBound Scientific with datalog files created by DMR.
#'
#' @details
#' This function has been designed for the SkyLine2D system file generated by
#' DMR synced with the Picarro G2508
#' (\ifelse{html}{\out{CO<sub>2</sub>}}{\eqn{CO[2]}{ASCII}},
#' \ifelse{html}{\out{CH<sub>4</sub>}}{\eqn{CH[4]}{ASCII}},
#' \ifelse{html}{\out{N<sub>2</sub>O}}{\eqn{N[2]O}{ASCII}} and
